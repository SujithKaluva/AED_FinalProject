...
public class ClinicAdminWorkArea extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addComponent(jPanel7, javax.swing.GroupLayout.DEFAULT_SIZE, 1500, Short.MAX_VALUE)
        );
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(quan.getText()==null){JOptionPane.showMessageDialog(this, "Enter Quantity");gh=false;}
        if(price.getText()==null){JOptionPane.showMessageDialog(this, "Enter price");gh=false;}
        if(odate.getDate()==null){JOptionPane.showMessageDialog(this, "Enter OrderDate");gh=false;}
         if(comments.getText()==null){JOptionPane.showMessageDialog(this, "Enter comments");gh=false;}
       if(gh)
        {    
    ...
    private void quanKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_quanKeyTyped
        ...
        {
            if(vd.getVaccine().getName()==Vaccine.getSelectedItem().toString())
