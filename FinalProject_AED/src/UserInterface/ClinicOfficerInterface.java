...
public class ClinicOfficerInterface extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Appointment ID", "Patient Name", "Vaccine Name", "Disease", "Status", "Phone number", "Email", "Date"
            }
        ));
...
//        this.locationPoint = locationPoint;
    ...
    private void populatevolunteer() {
        ...
        for (Volunteer vObj : ecoSystem.getVolunteerDirectory().getVolunteerDirectory()) {
            ...
            if (vObj.getClinic().getClinicId().equals(co.getClinicId())) {
                Object[] row = new Object[111];
